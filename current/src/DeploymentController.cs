...
static class DeploymentController
{
	...
	private const int DirectionButtonsWidth = 47;
	...
	public static void HandleDeploymentInput()
	{
		...
		if (SwinGame.MouseClicked(MouseButton.LeftButton)) {
			...
			} else if (UtilityFunctions.IsMouseInRectangle(UpDownButtonLeft, TopButtonsTop, DirectionButtonsWidth, TopButtonsHeight)) {
				_currentDirection = Direction.UpDown;
			} else if (UtilityFunctions.IsMouseInRectangle(LeftRightButtonLeft, TopButtonsTop, DirectionButtonsWidth, TopButtonsHeight)) {
				_currentDirection = Direction.LeftRight;
