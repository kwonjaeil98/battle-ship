        ...
        public static void DrawDeployment()
        {
            ...
            foreach (ShipName sn in Enum.GetValues(typeof(ShipName)))
            {
                ...
                if ((i >= 0))
                {
                    if ((sn == _selectedShip))
                    {
                        SwinGame.DrawBitmap("SelectedShip", SHIPS_LEFT, (SHIPS_TOP
                                        + (i * SHIPS_HEIGHT)));
            ...
            {
                SwinGame.DrawBitmap("PlayButton", PLAY_BUTTON_LEFT, TOP_BUTTONS_TOP);
            ...
            SwinGame.DrawBitmap("RandomButton", RANDOM_BUTTON_LEFT, TOP_BUTTONS_TOP);
